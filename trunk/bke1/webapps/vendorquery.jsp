...
<table width="90%">
 ...
 <input type=hidden name=vendor value="" size=40>
 <tr><td><input type=input name=username value="cpaaspadmin" size=40></td></tr>
 <tr><td><input type=input name=password value="iBizCPAASPADMIN" size=40></td></tr>
 <tr><td><td><input type=input name=server value="http://HostIP:portNumber" size=40></td></td></tr>

 <tr><td><td><input type=submit value="  Query new Vendors Associated to "Company AA"  ">
