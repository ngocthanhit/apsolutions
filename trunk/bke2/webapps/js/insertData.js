...
{ 
	...
	*/		
	...
	var lineItemTableId = document.getElementById('itemTableId').value;
	
		url1 = url1+"tb="+lineItemTableId+"&c1="+headerId_ColID+"&v1="+lineItemInvoiceId+"&c2="+ln_ColID+"&v2="+lineNumber;
