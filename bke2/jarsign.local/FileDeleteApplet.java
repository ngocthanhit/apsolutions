...
*/
	...
	public String submitFile(String fromFile, String toFile, String invoiceId, String baseUrlStr ){
		System.out.println("Applet recieved fromFile  "+fromFile);
		System.out.print("toFile "+toFile);
		System.out.print("invoiceId "+invoiceId);
		System.out.print("baseUrlStr "+baseUrlStr);
	...
	//			System.out.println("In submitFile 2 baseUrlStr  >>>"+baseUrlStr);
				URL url = new URL(baseUrlStr+"FileProcess.jsp?ii="+invoiceId+"&tf="+toFile);
	...
	public String ff,tf,ii,url1;
	public String sendFile(String fromFile,String toFile,String invoiceId,String urll ){
	...
	Permission perm = new RuntimePermission("accessDeclaredMembers");
		 ...
		 (String) AccessController.doPrivileged(new PrivilegedAction() {
		    public Object run() {
				...
				return submitFile(ff,tf,ii,url1);
		    }
		  })
		 :"";
	}
